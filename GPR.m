...
% Train a Gaussian Process Regression model using fitrgp
gprMdl = fitrgp(pn, tn, 'KernelFunction', 'squaredexponential','Standardize', true);

%% Model prediction
pyuce = predict(gprMdl, pm);  % Predict test set
